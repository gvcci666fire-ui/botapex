...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('pannello-link')
        .setDescription('Invia il pannello con i link utili del server')
    ...
    async execute(interaction: ChatInputCommandInteraction) {
        ...
        await interaction.reply({ content: '✅ Pannello link aggiornato con successo!', flags: ['Ephemeral'] });
    }
};
